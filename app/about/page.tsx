export default function About() {
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-4xl font-bold text-center mb-8 text-sprunki-purple">About Sprunki Incredibox</h1>
      <div className="max-w-2xl mx-auto bg-white p-6 rounded-lg shadow-lg border-2 border-sprunki-green">
        <p className="mb-4 text-sprunki-blue">
          Sprunki Incredibox is an innovative interactive music game that brings the joy of beat-mixing to your fingertips. Inspired by the popular Incredibox series, our platform offers a unique twist on music creation and rhythm exploration.
        </p>
        <p className="mb-4 text-sprunki-pink">
